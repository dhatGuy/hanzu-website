      ...
      <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all max-w-full max-h-full h-full">
        <div className="relative flex flex-col-reverse md:flex-row justify-center items-center h-full px-3 md:px-20 gap-6">
          ...
          <div className="relative">
            <button
              type="button"
              className="absolute -right-2 -top-2 size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-red-800 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none"
              aria-label="Close"
            ...
            <img
              ...
              alt={service.title}
              className="rounded-2xl aspect-square md:aspect-video object-cover"
            />
          </div>
        </div>
      </div>
