  ...
  return (
    <section className="p-8 md:p-16 overflow-hidden" id="services">
      <div className="flex items-center">
        <div className="max-w-7xl mx-auto flex flex-col gap-12 flex-1">
          <h2 className="text-3xl font-bold font-euro text-center md:text-left">
                ...
                >
                  <div
                    ...
                    className={cn(
                      ...
                      index !== activeIndex && "items-start flex-col mx-0"
                    )}
                  >
